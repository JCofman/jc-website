...
if (
  ...
  throw new Error(`The script hasnt run since you did not provide a webpagtest api key a test url and a git token`);
}
...
|----------|----------|----------|----------|----------|----------|----------|----------|----------|----------|
FirstView  | ${result.data.median.firstView.firstPaint} | ${result.data.median.firstView.firstContentfulPaint} | ${
    result.data.median.firstView.firstMeaningfulPaint
  } | ${result.data.median.firstView[`lighthouse.Performance.interactive`]} | ${result.data.median.firstView.TTFB} | ${
    result.data.median.firstView.render
  } | ${result.data.median.firstView.visualComplete} | ${result.data.median.firstView.SpeedIndex} | ${
    result.data.median.firstView.loadTime
  } |  
RepeatView | ${result.data.median.repeatView.firstPaint} | ${result.data.median.repeatView.firstContentfulPaint} | ${
  ...
  } | ${result.data.median.repeatView.render} | ${result.data.median.repeatView.visualComplete} | ${
    result.data.median.repeatView.SpeedIndex
  } | ${result.data.median.repeatView.loadTime} |  
  ## Metrics Average Run
  | View | First Paint | First Contentful Paint | First Meaningful Paint | Time to First Byte | Time to interactive |  Render Started |  Visualy Completed | SpeedIndex | Load Time |
  |----------|----------|----------|----------|----------|----------|----------|----------|----------|----------|
  FirstView  | ${result.data.average.firstView.firstPaint} | ${result.data.average.firstView.firstContentfulPaint} | ${
  ...
  } | ${result.data.average.firstView.render} | ${result.data.average.firstView.visualComplete} | ${
  ...
  } | ${result.data.average.repeatView.TTFB} | ${result.data.average.repeatView.render} | ${
    result.data.average.repeatView.visualComplete
  } | ${result.data.average.repeatView.SpeedIndex} | ${result.data.average.repeatView.loadTime} |  
# Waterfall
## FirstView median
  ...
  axios
    .post(slackHookUrl, {
      text: ` ⚡️🚀🚗💨  *New WebPagetest Results* for ${testURL} ⚡️🚀🚗💨 
             ...
             _First Contentful Paint:_ ${result.data.median.firstView.firstContentfulPaint}
             _First Meaningful Paint:_ ${result.data.median.firstView.firstMeaningfulPaint}
             _Time to Interactive:_ ${result.data.median.firstView[`lighthouse.Performance.interactive`]}
